...
class _MeetingPlannerState extends State<MeetingPlanner> {
    ...
    try {
      ...
      if(major.text.isEmpty){
        if(semester.text.isEmpty){
          await database.addMatch(place: place.text, starthour: starthour, startmin: startmin, endhour: endhour, endmin: endmin);
        }else{
          await database.addMatch(place: place.text, semester: int.parse(semester.text), starthour: starthour, startmin: startmin, endhour: endhour, endmin: endmin);
        }
      }else{
        if(semester.text.isEmpty){
          await database.addMatch(place: place.text, major: major.text, starthour: starthour, startmin: startmin, endhour: endhour, endmin: endmin);
        }else{
          await database.addMatch(place: place.text, major: major.text, semester: int.parse(semester.text), starthour: starthour, startmin: startmin, endhour: endhour, endmin: endmin);
        }
      }
  ...
  searchMatches() async{
    ...
    if(matches!.isNotEmpty && matches != null){
      ...
      createMatch();
      showCustomPopup('No Match found', 'Your Match is now in the waiting line!');
    }
  ...
  connectMatch(String id, int starthour_best, int startmin_best) async {
    try {
      print("match found");
      final value = await database.updateMatch(id: id, starthour: starthour_best, startmin: startmin_best);
      place.clear();
      major.clear();
      semester.clear();
      setState(() {
                  ...
                  children: [
                    ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: flag(1) ? null : Colors.greenAccent,
                      ),
                    ),
                    SizedBox(width: 16),
                    ElevatedButton(
                      ...
                      child: Text('Pastaria'),
                      style: ElevatedButton.styleFrom(
                        backgroundColor: flag(2) ? null : Colors.greenAccent,
                      ),
                    ),
                    SizedBox(width: 16),
                    ElevatedButton(
                      ...
                      child: Text('MAR'),
                      style: ElevatedButton.styleFrom(
                        backgroundColor: flag(3) ? null : Colors.greenAccent,
                      ),
                    ),
                  ],
                ),
                ...
                Row(
                  ...
                  children: [
                    ElevatedButton(
                      ...
                      child: Text('Skyline'),
                      style: ElevatedButton.styleFrom(
                        backgroundColor: flag(4) ? null : Colors.greenAccent,
                      ),
                    ),
                    SizedBox(width: 16),
                    ElevatedButton(
                      ...
                      child: Text('Veggie'),
                      style: ElevatedButton.styleFrom(
                        backgroundColor: flag(5) ? null : Colors.greenAccent,
                      ),
                    ),
                  ],
                ),
